import { EditableUser, User, ValidationError } from '../types/user.types';

export const validateUser = (user: EditableUser, allUsers: User[] = [], currentUserId?: string): ValidationError[] => {
